...
searchProductList.addEventListener("keyup", function () {
    ...
    r.addEventListener("click", function () {
        ...
        var t = r.querySelector(".listname").innerHTML, i = productListAllData.filter(e => e.product.category === t),
...
var minCostInput = document.getElementById("minCost"), maxCostInput = document.getElementById("maxCost"),
    filterDataAll = "", filterDataPublished = "";
slider.noUiSlider.on("update", function (e, t) {
    ...
    var s = maxCostInput.value.substr(2), a = minCostInput.value.substr(2);
...
searchBrandsOptions.addEventListener("keyup", function () {
    ...
    document.querySelectorAll("#flush-collapseBrands .form-check").forEach(function (e) {
